...
def demande(question):
	...
	while len(reponse)<1 or len(reponse)>11:
		if len(reponse)>11:
			print("Donnez un nom de moins de 11 caractères")
		if len(reponse)<1:
...
c.grid(row=0,rowspan=7,column=0,columnspan=2)
...
Wdrapeau0.grid(row=0,column=2)
drapeau1= PhotoImage(file="drapeau_en.png")
Wdrapeau1=Button(fen,image=drapeau1,command=english,width=100)
Wdrapeau1.grid(row=0,column=3)
drapeau2= PhotoImage(file="drapeau_de.png")
Wdrapeau2=Button(fen,image=drapeau2,command=deustch,width=100)
Wdrapeau2.grid(row=0,column=4)

#Emma: ajout des chronomètres
titreC1=StringVar()
titreC1.set(nomBlanc)
Wtitre1=Label(fen,textvariable=titreC1,width=15,font=("",20))
Wtitre1.grid(row=3,column=3)
titreC2=StringVar()
titreC2.set(nomNoir)
Wtitre2=Label(fen,textvariable=titreC2,width=15,font=("",20))
Wtitre2.grid(row=3,column=4)
titre0=StringVar()
titre0.set("")
Wtitre0=Label(fen,textvariable=titre0,width=10,font=("",20))
Wtitre0.grid(row=3,column=2)
titre3=StringVar()
titre3.set("")
Wtitre3=Label(fen,textvariable=titre3,width=17,font=("",20))
Wtitre3.grid(row=4,column=2)
titre4=StringVar()
titre4.set("")
Wtitre4=Label(fen,textvariable=titre4,width=10,font=("",20))
Wtitre4.grid(row=5,column=2)

textChrono1=StringVar()
textChrono1.set(".......")
Wchrono1=Label(fen,textvariable=textChrono1, width=15,font=("",20))
Wchrono1.grid(row=4,column=3)
textChrono2=StringVar()
textChrono2.set(".......")
Wchrono2=Label(fen,textvariable=textChrono2, width=15,font=("",20))
Wchrono2.grid(row=4,column=4)
textChrono3=StringVar()
textChrono3.set("0 s")
Wchrono3=Label(fen,textvariable=textChrono3, width=15,font=("",20))
Wchrono3.grid(row=5,column=3)
textChrono4=StringVar()
textChrono4.set("0 s")
Wchrono4=Label(fen,textvariable=textChrono4, width=15,font=("",20))
Wchrono4.grid(row=5,column=4)

#Emma: création des Labels pour donner les instructions
message1=StringVar()
message1.set("Initialisation en cours")
Wmessage1=Label(fen,textvariable=message1,width=40,font=("",18))
Wmessage1.grid(row=7,column=1)

message2=StringVar()
message2.set("Initialisation en cours")
Wmessage2=Label(fen,textvariable=message2,width=40,font=("",18))
Wmessage2.grid(row=7,column=2,columnspan=3)

textFinTour=StringVar()
textFinTour.set("")
Wtour=Button(fen,textvariable=textFinTour,command=Tour,width=12,font=("",18))
Wtour.grid(row=8,column=2)

textJouer=StringVar()
textJouer.set("")
Winterrupteur=Button(fen,textvariable=textJouer,command=debut,width=12,font=("",18))
Winterrupteur.grid(row=8,column=1)

textQuitter=StringVar()
textQuitter.set("")
Wquitter=Button(fen,textvariable=textQuitter,command=fen.quit,font=("",18))  
Wquitter.grid(row=8,column=3,columnspan=2) 
